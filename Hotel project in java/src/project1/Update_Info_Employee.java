...
public class Update_Info_Employee extends javax.swing.JFrame {

    public Update_Info_Employee() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_Info_Employee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Update_Info_Employee().setVisible(true);
            }
        });
    }
