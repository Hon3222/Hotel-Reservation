...
public class If_He_Didnot_Customer extends javax.swing.JFrame {
    public If_He_Didnot_Customer() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Reservation_Class insert= new Reservation_Class ();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(If_He_Didnot_Customer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new If_He_Didnot_Customer().setVisible(true);
            }
        });
    }
