...
public class Show_Service extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Show_Service.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
