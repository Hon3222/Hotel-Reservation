...
import static project1.Room_Management_Module.c;

public class Avalable_Rooms extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Avalable_Rooms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
